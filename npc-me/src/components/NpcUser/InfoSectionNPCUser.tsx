    ...
    return (
        <section>
            <div className="infoSection">
                ...
                <article>
                    <div className="infoSection_messages_box2">
                        ...
                        <h2 className="infoSection_messages_title2">Take your time to get ready before starting</h2>
                    ...
                    <NavLink to={"/my-profile"} className="link2">Go to Lily's profile</NavLink>
                </article>
            </div>
            <article className="infoSection_videos">
            </article>
